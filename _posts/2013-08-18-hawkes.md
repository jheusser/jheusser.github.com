...
The parameters can be fitted using conventional Maximum Likelihood Estimation and a convex solver. Alternatively, you can use an R package such as _ptproc_ [9], which is what I am going to use in this article.
